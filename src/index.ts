import { FormDetails } from "./forms/create";
...
class GoogleForms {
    ...
    loadForms(): void {
        ...
        if (this.formData === null || typeof this.formData !== 'object' || this.formData.length === 0) {
            ...
            this.formData.forEach((form: FormDetails) => {
...
(window as any).googleForms = googleForms;
